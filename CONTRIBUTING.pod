...
Added the module name in alphabetical order to the @MODULES or @CURRENCY_MODULES variable in Quote.pm.
...
Go to https://github.com/finance-quote/finance-quote
...
Commit your new module and other code changes to the fork

=item 5.

Click "New Pull Request" on https://github.com/finance-quote/finance-quote
...
Select the appropriate commits and create the merge request

...
To develop and test modules, you need a clone of the Finance-Quote git repo,
a recent version of perl, and the Dist::Zilla module and its dependencies.
The following steps provide a recipe for setup.

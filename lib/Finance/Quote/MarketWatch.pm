...
sub marketwatch {
  ...
  $ua->agent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36");
  ...
  # Enable cookie handling (websites often check if you can store cookies)
  $ua->cookie_jar({});
